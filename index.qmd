...
:::{.column-margin}
Dá para colocar texto e figuras em margem, etc. Usa o [*bootstrap*](https://getbootstrap.com/) para formatar o conteúdo html.
...
mapaInterativo = {
  ...
  baterLayer.bindPopup("aqui aparecem dados da BATER");

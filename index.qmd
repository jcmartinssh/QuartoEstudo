...
MUNICjsonURL = "https://geoservicos.ibge.gov.br/geoserver/CGEO/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=CGEO%3APARBR2018_SedeMunicipal&maxFeatures=600000&outputFormat=application%2Fjson"

municipios = d3.json(MUNICjsonURL)

// Inputs.table(municipios) 

viewof selmun = Inputs.select(
  municipios.features.map((d) => d.properties.),
  {
    sort: true,
    unique: true,
    label: "Município"
...
// municipioArray = municipios.features.filter((d) => d.properties.municipio == selmun)
``` -->
...
BATERjsonURL = "https://geoservicos.ibge.gov.br/geoserver/CGEO/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=CGEO%3APARBR2018_BATER_MD&maxFeatures=600000&outputFormat=application%2Fjson"

bater = d3.json(BATERjsonURL)
``` -->
